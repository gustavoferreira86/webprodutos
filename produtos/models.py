...
class Produtos(models.Model):
    ...
    fornecedores_idfornecedores = models.ForeignKey(Fornecedores, db_column='Fornecedores_idFornecedores', blank=True, null=True, verbose_name='Fornecedor')  # Field name made lowercase.
    ...
    categoria_idcategoria = models.ForeignKey(Categoria, db_column='Categoria_idCategoria', blank=True, null=True, verbose_name='Categoria')  # Field name made lowercase.

    def get_self(self):
     return self
	 
    def get_fields_and_values(self):
     return [(field, field.value_to_string(self)) for field in Produtos._meta.fields]
